...
public class MemberController {
	...
	public Map<String, Object> getMembers(@RequestParam(value="startPage", defaultValue="0")int startPage) {
		System.out.println("맴버 리스트 매서드 요청" + startPage);
	
		Map<String, Object> map = memberService.selectMemberList(startPage);
		System.out.println("리스트 개수 list.size()" + map.size());
		System.out.println("컨트롤 map : " + map);
		return map;
	}
